...
public class ProduccionDAO {
    ...
    public ProduccionDAO(Supplier<Connection> connectionSupplier) {
    ...
    public boolean editarPedido(Pedido ped) {
        try {
            ...
            ps.setString(1, ped.getCliente());
            ps.setDate(2, new java.sql.Date(ped.getFechaEntrega().getTime()));
    ...
    public void llenarComboPedidos(JComboBox combo) {
        try {
            ...
            String sql = "SELECT idPedido, cliente FROM pedido";
