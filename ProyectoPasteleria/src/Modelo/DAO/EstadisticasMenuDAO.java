...
public class EstadisticasMenuDAO {
    ...
    public int contarEmpleados(){
        ...
        try{
            ...
            String sql = "SELECT COUNT(*) total FROM empleado";
    ...
    public int contarIngredientes(){
        ...
        try{
            Connection con = (this.conexion != null) ? this.conexion : ConexionBD.getConexionBD();
            String sql = "SELECT COUNT(*) total FROM ingredientes";
            PreparedStatement ps = con.prepareStatement(sql);
            ResultSet rs = ps.executeQuery();
            if(rs.next()){
                total = rs.getInt("total");
    ...
    public int contarPedidos(){
        ...
        try{
            Connection con = (this.conexion != null) ? this.conexion : ConexionBD.getConexionBD();
            String sql = "SELECT COUNT(*) total FROM pedido";
            PreparedStatement ps = con.prepareStatement(sql);
            ResultSet rs = ps.executeQuery();
            if(rs.next()){
                total = rs.getInt("total");
    ...
    public int contarProductos(){
        ...
        try{
            Connection con = (this.conexion != null) ? this.conexion : ConexionBD.getConexionBD();
            String sql = "SELECT COUNT(*) total FROM producto";
            PreparedStatement ps = con.prepareStatement(sql);
            ResultSet rs = ps.executeQuery();
            if(rs.next()){
                total = rs.getInt("total");
    ...
    public int contarTarjetas(){
        ...
        try{
            Connection con = (this.conexion != null) ? this.conexion : ConexionBD.getConexionBD();
            String sql = "SELECT COUNT(*) total FROM tarjetaTiempo";
            PreparedStatement ps = con.prepareStatement(sql);
            ResultSet rs = ps.executeQuery();
            if(rs.next()){
                total = rs.getInt("total");
